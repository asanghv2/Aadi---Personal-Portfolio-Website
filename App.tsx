...
const App: React.FC = () => {
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent(
      contactForm.subject || `Message from ${contactForm.name}`
    );
    ...
    // Optional UX: clear form after triggering mail client
      ...
      <div className="max-w-6xl mx-auto px-4 pt-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <main className="flex-1 space-y-16 lg:space-y-24">
            ...
            <section
              id="about"
              className="scroll-mt-24 animate-in fade-in slide-in-from-bottom-3 duration-700"
            >
            ...
            <section id="projects" className="scroll-mt-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {RESUME_DATA.projects.map((project, idx) => (
                  <div
                    key={idx}
                    className="group bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2"
                  >
                    ...
                    <div className="p-6">
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.tags.map((tag, i) => (
                          <span
                            key={i}
                            className="text-[9px] font-bold uppercase tracking-widest text-blue-600 px-2 py-0.5 bg-blue-50 rounded"
                          >
                            {tag}
                          </span>
                        ))}
            ...
            <section id="education" className="scroll-mt-24">
              ...
              <div className="space-y-6">
                {RESUME_DATA.education.map((edu, idx) => (
                  <div
                    key={idx}
                    className="bg-white p-8 rounded-3xl border border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4"
                  >
                    <div>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[3rem] p-8 lg:p-16 text-white shadow-xl">
                <div className="max-w-3xl mx-auto">
                  ...
                  <p className="text-blue-100 mb-12 text-center text-lg">
                    ...
                    form below and it will send an email directly to{" "}
                    <strong>{RESUME_DATA.email}</strong>.
                  </p>

                  <form
                    onSubmit={handleContactSubmit}
                    className="bg-white rounded-[2rem] p-8 lg:p-10 shadow-2xl text-slate-900 space-y-6"
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
